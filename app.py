...
# Remove argparse code and replace with click
@click.command()
@click.option('--online_checkpoint_url', default="https://myshell-public-repo-hosting.s3.amazonaws.com/checkpoints_1226.zip", 
...
@click.option('--port', type=int, default=None,
              help="Server port")
def main(online_checkpoint_url, share, host, port):
    ...
    **Join the Community** |   [![Discord](https://img.shields.io/discord/1122227993805336617?color=%239B59B6&label=%20Discord%20)](https://discord.gg/myshell) |
    ...
    # Move the demo launch inside the main function
    demo.queue()
    demo.launch(debug=True, show_api=True, share=share, 
